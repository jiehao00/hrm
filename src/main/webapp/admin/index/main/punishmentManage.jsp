...
<div class="layui-tab layui-tab-brief " lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        <div class="posLi">
            <li class="layui-this">惩罚信息</li>
            <li>添加惩罚</li>

        </div>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show"><table id="showPunishmentTable" lay-filter="showPunishmentTable"></table></div>
...
<script type="text/html" id="toolShowRewardsBar">
    <div class="demoTable">
        ...
        <div class="layui-inline">
            <input  class="layui-input" name="startTime" id="startTime" autocomplete="off" placeholder="惩罚时间"/>
        </div>
        <div class="layui-inline">
            --
        </div>
        <div class="layui-inline">
            <input  class="layui-input" name="endTime" id="endTime" autocomplete="off" placeholder="惩罚时间"/>
        </div>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="addPunishment">添加</a>
</script>
...
<script type="text/javascript" src="../../../js/punishmentManage.js" charset="UTF-8"></script>
</body>
</html>
