...
public class TrainingInfo {
    ...
    public void setTrainingHour(String trainingHour) {
        this.trainingHour = trainingHour;
    }

    public String getTrainingScores() {
        return trainingScores;
    }

    public void setTrainingScores(String trainingScores) {
    ...
    public void setTrainingEvaluation(String trainingEvaluation) {
